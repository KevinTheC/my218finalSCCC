...
public class HashMapArrayList {
	/**
	 * HashMap -> ArrayList method
	 * @author me
	 *
	 */
	private class Pair{
		private int ct;
		private ArrayList<String> setofNextWords;
		public Pair() {
			setofNextWords=new ArrayList<>();
			ct=0;
		}
		...
		public Optional<String> getRandom() {
			...
			return Optional.of(setofNextWords.get(rand.nextInt(ct)));
		}
	}
	 ...
	 */
	private HashMap<String,Pair> ts;
	private int ct;
	public HashMapArrayList(){
		ts=new HashMap<String,Pair>();
		ct=0;
	}
